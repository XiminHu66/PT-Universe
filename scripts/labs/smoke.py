...
def verify():
    for app in ('thesis-lab', 'earnings-dojo', 'tsugi-checker', 'eastside-weekend'):
        html = get('apps/' + app + '/')
        assert ('id="pcpForm"' in html) if app=='tsugi-checker' else ('id="app"' in html and 'id="health"' in html), app
    ...
    print('PUBLICATION CHECK PASSED: four pages and two independent snapshots')
