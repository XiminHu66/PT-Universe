...
- The toolbar refresh button uses the deployed allowlisted Cloudflare Worker in `workers/rss-orbit-proxy` for complete live refreshes. Users can override or disable it locally; browser and repository-cache fallbacks remain available.
