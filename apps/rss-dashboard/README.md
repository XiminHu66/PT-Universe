...
- The toolbar refresh button fetches enabled RSS sources directly in the browser, falling back to the repository cache when a source or public CORS relay is unavailable.
